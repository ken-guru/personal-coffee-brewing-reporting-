...
describe('formatBrewingMethod', () => {
  ...
  it('formats aeropress-go', () => expect(formatBrewingMethod('aeropress-go')).toBe('Aeropress Go'));
  it('formats kalita', () => expect(formatBrewingMethod('kalita')).toBe('Kalita Hand Brewer'));
  it('formats siemens-drip', () => expect(formatBrewingMethod('siemens-drip')).toBe('Siemens Coffee Brewer'));
